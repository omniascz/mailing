...
| \*_Mailchimp `_                                        | IF:                                                         | \*` syntax compatibility\*\*          | ❌       | only Mailchimp                                              | M   | 1-2 days (parser) — eases migration |
...
| \*_Mailchimp `_                                  | MERGE                                                     | \*` syntax translation\*\*               | ❌                  | only Mailchimp natively                             | M   | 2 days (parser → `{{merge}}`) |
...
_Status: pracovní podklad pro email layer P0 backlog_
