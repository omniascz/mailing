...
const leadScoringRoutes: FastifyPluginAsync = async (app) => {
  ...
  // ── Seed default rules ──────────────────────────────────────────────────────
  app.post(`${prefix}/rules/seed-defaults`, {
    preHandler: [app.authenticate],
    schema: {
      tags: ['lead-scoring'],
  ...
  app.get(`${prefix}/contacts/:id/history`, {
    preHandler: [app.authenticate],
    schema: {
      tags: ['lead-scoring'],
