...
const savedQueryRoutes: FastifyPluginAsync = async (app) => {
  app.get('/api/v1/analytics/saved-queries', {
  ...
  app.post('/api/v1/analytics/saved-queries', {
    preHandler: [app.authenticate],
  ...
  app.get('/api/v1/analytics/saved-queries/:id', {
    preHandler: [app.authenticate],
  ...
  app.patch('/api/v1/analytics/saved-queries/:id', {
    preHandler: [app.authenticate],
  ...
  app.delete('/api/v1/analytics/saved-queries/:id', {
    preHandler: [app.authenticate],
