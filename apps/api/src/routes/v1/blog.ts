...
const blogRoutes: FastifyPluginAsync = async (app) => {
  ...
  app.patch('/api/v1/blog/posts/:id', {
    preHandler: [app.authenticate, app.requireRole('editor', 'admin', 'owner')],
  ...
  app.post('/api/v1/blog/posts/:id/publish', {
    preHandler: [app.authenticate, app.requireRole('editor', 'admin', 'owner')],
  ...
  app.post('/api/v1/blog/posts/:id/schedule', {
    preHandler: [app.authenticate, app.requireRole('editor', 'admin', 'owner')],
  ...
  app.post('/api/v1/blog/posts/:id/archive', {
    preHandler: [app.authenticate, app.requireRole('editor', 'admin', 'owner')],
  ...
  app.delete('/api/v1/blog/posts/:id', {
  ...
  app.post('/api/v1/blog/categories', {
    preHandler: [app.authenticate, app.requireRole('editor', 'admin', 'owner')],
  ...
  app.get('/api/v1/blog/public/:slug', {
