...
const reportRoutes: FastifyPluginAsync = async (app) => {
  app.get(
    '/api/v1/crm/reports/deals-by-stage',
    {
  ...
  app.get(
    '/api/v1/crm/reports/conversion-rates',
    {
      preHandler: [app.authenticate],
      schema: { tags: ['CRM Reports'] },
    },
  ...
  app.get(
    '/api/v1/crm/reports/sales-velocity',
    {
      preHandler: [app.authenticate],
      schema: { tags: ['CRM Reports'] },
    },
  ...
  app.get(
    '/api/v1/crm/reports/rep-performance',
    {
      preHandler: [app.authenticate],
      schema: { tags: ['CRM Reports'] },
    },
  ...
  app.get(
    ...
    async (req, reply) => {
      const q = z
        ...
        .parse(req.query);
      return reply.send({
        data: await forecastPipeline(req.user!.orgId, q.pipelineId, {
