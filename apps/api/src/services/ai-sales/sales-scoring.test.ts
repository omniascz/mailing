...
describe('win-probability scoreFromFeatures', () => {
  ...
  it('recent 30d activity adds a positive factor', () => {
    const r = scoreFromFeatures({
      ...baseFeatures,
      recentEmailOpens30d: 3,
      recentEmailClicks30d: 1,
    });
