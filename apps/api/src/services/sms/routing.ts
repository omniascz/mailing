...
import { BulkgateSmsAdapter, type BulkgateAdapterConfig } from '../../channels/sms/bulkgate-adapter.js';
...
const PREFIX_COUNTRY: [string, string][] = [
  ...
  ['1204', 'CA'], ['1226', 'CA'], ['1250', 'CA'], ['1289', 'CA'], ['1306', 'CA'],
  ['1403', 'CA'], ['1416', 'CA'], ['1418', 'CA'], ['1431', 'CA'], ['1437', 'CA'],
  ['1438', 'CA'], ['1450', 'CA'], ['1506', 'CA'], ['1514', 'CA'], ['1519', 'CA'],
  ['1604', 'CA'], ['1613', 'CA'], ['1647', 'CA'], ['1705', 'CA'], ['1709', 'CA'],
  ...
  ['370', 'LT'], ['371', 'LV'], ['372', 'EE'], ['351', 'PT'], ['353', 'IE'],
  ['358', 'FI'], ['359', 'BG'], ['357', 'CY'], ['352', 'LU'],
  // US/Canada catch-all
  ['1', 'US'],
];
