# EmailLabs – hloubková analýza funkcí

**Verze dokumentu:** 1.0 · **Datum:** květen 2026
**Zdroje:** oficiální dokumentace emaillabs.io / emaillabs.pl + docs.emaillabs.io + analytické weby (G2, Capterra, SourceForge, European Alternatives, Base.com) ověřené v dubnu–květnu 2026.
**Rozsah:** kompletní funkcionalita platformy v roce 2026 – Cloud SMTP & Email API, transactional + marketing emails, deliverability infrastructure, dedicated IPs, real-time analytics, security (SPF/DKIM/DMARC/S/MIME).

> **Důležitý kontext:** EmailLabs je **polská CPaaS platforma** (Communications Platform as a Service) provozovaná společností **Vercom S.A. Group**. **NENÍ to marketing campaign builder!** Je to **email delivery infrastructure** – SMTP relay + Email API.
>
> **Pozice:** **Email delivery service** pro transactional + bulk emails. **NE marketing automation suite** jako Mailchimp/Brevo/Klaviyo. **Doplňuje** marketing automation systémy (SALESmanago, Bloomreach, Mautic, atd.).
>
...
> - **0.16 seconds** delivery speed (per oficiální)
> - **Dedicated IPs** s controllable reputation
> - **Generous free plan: 24,000 emails/měsíc**
> - **Pro plan from €23/month**
> - **Built-in marketing/transactional separation** (avoids throttling)
> - **Specialized Polish market expertise** + Czech, German, French ISP relationships
> - **Email Deliverability Academy** (thought leadership)
> - **S/MIME signing** + digital certificates (UNIKÁTNÍ pro CZ/PL market)
> - **English + Polish UI**
...
1. [Co je EmailLabs a pro koho je](#1-co-je-emaillabs)
2. [Tarify a pricing](#2-tarify)
3. [Klíčové diferenciátory v CEE kontextu](#3-diferenciatory)
4. [Cloud SMTP relay](#4-smtp-relay)
5. [Email API (RESTful)](#5-email-api)
6. [Dedicated IPs](#6-dedicated-ips)
7. [Deliverability infrastructure](#7-deliverability)
8. [Marketing vs. Transactional separation](#8-mkt-vs-trans)
9. [Real-time analytics](#9-analytics)
10. [Email authentication (SPF/DKIM/DMARC)](#10-authentication)
11. [S/MIME signing + certifikáty](#11-smime)
12. [Reputation Defender](#12-reputation-defender)
13. [List health monitoring + spam traps](#13-list-health)
14. [Integrace - SALESmanago, Bloomreach, Mautic](#14-integrations-marketing)
15. [Integrace - E-commerce platforms](#15-integrations-ecommerce)
16. [Integrace - CMS + CRM](#16-integrations-cms)
17. [ISP relationships (PL, CZ, DE, FR)](#17-isp)
18. [SDK + Libraries](#18-sdk)
19. [Email Deliverability Academy](#19-academy)
20. [Support (responsive top-rated)](#20-support)
21. [Compliance, GDPR, EU hosting](#21-compliance)
22. [Use cases (reference customers)](#22-use-cases)
...
- **Společnost:** Vercom S.A. Group
- **Brand:** EmailLabs
- **HQ:** **Polsko**
- **Industry:** **CPaaS (Communications Platform as a Service)**
- **Pozice:** **Email delivery infrastructure** specialist
- **Service type:** **Cloud SMTP & Email API** (NOT campaign builder!)
- **Volume:** **6+ billion messages annually**
- **Trust:** **700,000+ companies** (per oficiální claim)
- **UI Languages:** **English + Polish** (only 2 - per G2)
- **Support:** **Phone + online** (per G2)
- **Web:** emaillabs.io / emaillabs.pl
...
```
Cílový profil:
- Mají vlastní campaign/email system
- Potřebují lepší deliverability
- Chtějí dedicated IP s vlastní reputation
- Potřebují vysokou throughput
- Chtějí transparent analytics
...
- **Eobuwie.pl** (largest eCommerce brands in Poland, several hundreds of thousands orders daily)
- **Promote International** (Swedish education company)

```
┌─────────────────────────────────────────────────────────────────┐
│              EMAILLABS PLATFORM (Vercom S.A. Group)             │
│              Cloud SMTP & Email API · CPaaS                     │
│              700,000+ companies · 6+ billion messages/year      │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ Cloud SMTP     │  │ Email API    │  │ Dedicated IPs   │      │
│  │ Relay          │  │ (RESTful)    │  │ + Shared IPs    │      │
│  │ (5 min start)  │  │              │  │ pools           │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ Marketing vs   │  │ Real-time    │  │ Reputation      │      │
│  │ Transactional  │  │ Analytics    │  │ Defender        │      │
│  │ Separation     │  │ (deliv,      │  │ (proactive list │      │
│  │                │  │ bounces, ...)│  │  health)        │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ SPF / DKIM /   │  │ TLS          │  │ S/MIME signing  │      │
│  │ DMARC          │  │ Encryption   │  │ + Digital       │      │
│  │ Authentication │  │              │  │ certifikáty     │      │
│  │                │  │              │  │ (lokální trhy)  │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ 0.16 seconds   │  │ Spam trap    │  │ Sender          │      │
│  │ delivery       │  │ detection    │  │ reputation      │      │
│  │ speed          │  │              │  │ monitoring      │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ Email          │  │ List health  │  │ Send accurate   │      │
│  │ Deliverability │  │ monitoring   │  │ emails s        │      │
│  │ Academy        │  │              │  │ dynamic         │      │
│  │ (thought lead) │  │              │  │ filtering       │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
├─────────────────────────────────────────────────────────────────┤
│   INTEGRATIONS (per G2/oficiální):                              │
│   ├─ Marketing Automation:                                      │
│   │  - SALESmanago (PL native!)                                 │
...
├─────────────────────────────────────────────────────────────────┤
│   PRICING:                                                      │
│   - Free plan: 24,000 emails/měsíc                              │
│   - Pro plan: from €23/month                                    │
│   - Additional emails: purchase per plan                        │
...
- **E-commerce platforms** (transactional - order confirmations)
- **SaaS applications** (password resets, notifications)
- **CRM / ERP systems** (system-generated emails)
- **Marketing Automation platforms** (campaign delivery infrastructure)
- **Gym software** (eFitness)
- **Education platforms** (Promote International)
- **High-volume senders** (10K+ daily)
- **EU privacy-conscious** organizations
- **Polish + CEE businesses** (local ISP optimization)
...
- Better features
- Priority support
- Dedicated IP option (additional)

### 2.3 Pricing model

```
Pricing structure:
- Free: 24,000 emails/měsíc
- Pro plans: tiered by volume (od €23/měsíc)
- Additional emails: purchase per plan
- Custom enterprise: sales-driven
   ↓
Per oficiální:
"it is possible to purchase additional emails for all plans"
```
...
## 3. Klíčové diferenciátory v CEE kontextu
...
- **Best-of-Breed for email delivery**
...
- **Critical pro UX** (password reset urgency)
...
- **French ISPs**
- **Customized throttling** per market
...
- SMTP host: smtp.emaillabs.io (or similar)
- Port: typically 587 (TLS) or 465 (SSL)
- Username: provided by EmailLabs
- Password / SMTP key: provided
- TLS/SSL: yes
   ↓
Application sends emails via SMTP:
- Standard SMTP protocol
- No code changes required (existing apps)
- Plug-and-play
   ↓
EmailLabs receives:
- Authenticates
...
- E-shop → SMTP relay → customers
- CMS (WordPress, Joomla) → SMTP → users
- Marketing Automation (SALESmanago) → SMTP → recipients
- Custom apps → SMTP → users
```
...
- failed
   ↓
Real-time push to your application
   ↓
Update your system records
```
...
### 6.3 Shared vs. Dedicated

```
Shared IP pool:
- Default for many plans
- EmailLabs manages IP reputation
...
- **Domestic ISPs authorized** (PL/CZ/DE/FR)
- **Choose per use case**
...
- **EmailLabs guidance**
- **Reputation building**
- **No instant full volume**

### 6.6 Multiple dedicated IPs

- **Enterprise option**
- **One IP per use case** (marketing vs. transactional)
- **One IP per brand** (multi-brand companies)
- **One IP per market** (PL vs. DE vs. FR)
...
- **Better UX**
- **Critical pro time-sensitive** comms
...
## 8. Marketing vs. Transactional separation
...
```
Customer setup:
- 2 EmailLabs accounts/streams:
  - Marketing stream → marketing IP pool
  - Transactional stream → transactional IP pool
   ↓
Configure:
- Marketing system → marketing endpoint
- Transactional system → transactional endpoint
   ↓
Separated reputation
Separated throttling
Separated analytics
```
...
```
E-shop:
- Order confirmations → transactional IP
  - Speed: 0.16s
  - Reputation: high
  - Always delivered

- Newsletter campaigns → marketing IP
  - Volume: bulk
  - May have engagement variations
  - Doesn't impact transactional
   ↓
Best of both worlds
```

### 8.5 Vs. all-in-one platforms

```
All-in-one (Mailchimp/Brevo):
- Same IP pool for all
- Marketing issues impact transactional
- One reputation
- Less control
...
- Webhook events
- Integration s analytics tools (Google Analytics)
...
SPF setup:
- DNS TXT record
- Lists authorized sending IPs/hostnames
- EmailLabs provides record
- Add to your domain DNS
   ↓
Recipient ISPs check SPF
   ↓
If valid: pass
If invalid: spam folder / reject
```
...
```
DKIM setup:
- DNS TXT record s public key
- EmailLabs signs outgoing emails s private key
...
### 10.5 Gmail/Yahoo 2024+ compliance
...
- One-click unsubscribe (RFC 8058)
   ↓
EmailLabs handles all natively
   ↓
Customers compliant by default
```
...
- **Encrypted SMTP**
- **MX-to-MX encryption**
- **Standard secure transmission**

---

## 11. S/MIME signing + certifikáty
...
- **CZ market**
- **DE market**
- **Local certificate authorities** (eIDAS compliance possible)

### 11.5 Implementation

```
S/MIME setup (custom):
- Obtain S/MIME certificate (CA)
- Install na EmailLabs infrastructure
- Configure signing rules
- Test signed emails
- Verify recipient receives signed
   ↓
[Signed emails active]
```
...
```
Reputation Defender (or similar proprietary):
- Big data analysis
- Email list health monitoring
- Domain reputation protection
- IP reputation protection
- Proactive bad email suppression
   ↓
Hard bounces:
- Permanent failures suppressed

Soft bounces:
- Temporary failures monitored
...
- Suppressed immediately
   ↓
Deliverability incrementally better
```
...
## 13. List health monitoring + spam traps
...
- **% bounced**
- **% complained**
- **% engaged (opens/clicks)**
- **Spam trap hits**
- **Risky addresses**

### 13.2 Spam trap detection

```
Spam traps = email addresses used by ISPs to identify spammers
   ↓
EmailLabs detects:
- Pristine traps (never-real addresses)
- Recycled traps (abandoned addresses)
- Typo traps (common typos like @gnail.com)
   ↓
Notifies customer
   ↓
...
### 13.3 Health improvements

```
List health declining
   ↓
EmailLabs alerts:
- "Your list quality has decreased"
- Specific issues identified
- Recommendations provided
   ↓
Actions:
- Re-engagement campaign (existing tool)
- Remove inactive
- Validate addresses
- Update form/double opt-in
   ↓
Health improves
   ↓
...
## 14. Integrace - SALESmanago, Bloomreach, Mautic
...
### 14.7 Integration philosophy

```
EmailLabs philosophy:
- We don't compete s campaign tools
- We deliver their emails better
- Win-win partnership
- Customer keeps existing workflow
```

---

## 15. Integrace - E-commerce platforms
...
- **Polish e-commerce platform leader**
- Native integration
- Order confirmations, shipping, etc.
- Critical pro PL e-shops

### 15.3 Magento / Adobe Commerce
...
### 15.5 WooCommerce (WordPress)

- WordPress-based e-commerce
- Plugin: WP Mail SMTP + EmailLabs
- Easy setup
...
- EmailLabs delivery improves all
...
## 17. ISP relationships (PL, CZ, DE, FR)
...
```
Polish ISP expertise:
- WP.pl
- Onet.pl
- Interia.pl
- Other Polish providers
   ↓
EmailLabs:
- Optimized throughput per ISP
...
```
French ISP expertise:
- Orange
- Free.fr
- Laposte.net
   ↓
French market delivery
```

### 17.6 International

- **Gmail, Outlook, Yahoo** (global)
- **Apple Mail**
- **Smaller European providers**
- **Global ISP relationships**
...
(Based on industry standard CPaaS services)

- **PHP** (very common in PL/CZ market)
- **Python**
- **Node.js / JavaScript**
- **Java**
- **C# / .NET**
...
- **GitHub repositories** (likely)
- **Quick-start guides**
- **Per-language tutorials**
...
## 19. Email Deliverability Academy
...
```
Academy content likely:
- Email authentication guides
- Deliverability best practices
- List hygiene tutorials
- ISP relationships
...
```
Customer benefits:
- Better understanding of email
- Reduce deliverability issues
- Improve campaign ROI
- Self-sufficient marketers
...
## 20. Support (responsive top-rated)
...
### 21.4 Polish regulations

- **UODO compliance** (Polish data protection)
- **RODO compliance** (Polish GDPR)
- **Polish banking regulations** (for S/MIME use cases)
- **Local market expertise**

### 21.5 EU customer benefits

```
EU customer wants EmailLabs because:
- No US data transfer issues
- Schrems II concerns addressed
...
## 22. Use cases (reference customers)
...
- Optimization needed
- EmailLabs delivers reliable scale
...
- EmailLabs delivers globally

### 22.5 Use case patterns

```
Common EmailLabs use cases:
1. E-commerce transactional (highest volume)
2. SaaS notifications + alerts
3. Marketing automation delivery layer
4. ERP system communications
5. CRM email delivery
6. CMS-driven mailings
7. Gym/fitness management
8. Banking/finance (s S/MIME)
9. Education platforms
10. High-volume bulk campaigns
```
...
- **NE Mailchimp/Brevo alternative** for campaign creation
- **JE infrastructure** doplňující jiné systémy
...
- EmailLabs sama není end-user product
...
### 23.9 No marketing automation features
...
### 23.10 No SMS / multi-channel

- **Email only**
- **No SMS**
- **No WhatsApp**
- **No push notifications**
- (vs. Brevo / SALESmanago multi-channel)

### 23.11 Less brand recognition globally

- **Polish market leader**
- **Less known outside CEE**
- **Smaller community vs. SendGrid**
- **Fewer resources online (English)**

### 23.12 Tutorial/learning curve pro advanced features

```
Features requiring expertise:
- DMARC policy tuning
- IP warm-up strategy
...
- Per-ISP optimization
   ↓
EmailLabs support helps
But initial learning curve exists
```

### 23.13 No native A/B testing UI

- Customer's existing system handles A/B
- EmailLabs delivers both variants
- No EmailLabs-side A/B builder

### 23.14 No customer segmentation tools

- Customer's system handles segmentation
- EmailLabs delivers per segment
- No segmentation features v EmailLabs

### 23.15 Less integrations than market leaders

- Per G2: ~17-18 listed integrations
- Vs. SendGrid: hundreds via Twilio ecosystem
- Vs. Mailchimp: massive marketplace
- Sufficient pro PL+CEE core needs
- Less pro global integration heavy
...
- Provozujete **CEE business** (Polsko, Česko, Německo, Francie) – local ISP expertise
- Provozujete **e-commerce s vysokým volumem** (transactional)
- Provozujete **Polish business** (native expertise)
- Používáte **SALESmanago** (PL native integration)
- Používáte **Bloomreach Engagement** (CZ origin integration)
- Provozujete **Mautic** open-source automation
- Hledáte **dedicated IP** s controllable reputation
- Cíl je **marketing/transactional separation**
- Vyžadujete **S/MIME** signing (banking, financial)
- Provozujete **high-volume sender** (millions of emails)
- Hledáte **non-throttled** quotas
- Cíl je **0.16s** transactional delivery (password resets, OTP)
- Hodnotíte **responsive support** s ISP advocacy
- Začínáte s **24K emails/měsíc free** plan
- Provozujete **IdoSell e-shop** (PL leader)
...
- Potřebujete **drag-drop email editor** – Mailchimp/MailerLite
- Cíl je **workflow automation builder** – ActiveCampaign / HubSpot
- Provozujete **content creator business** – Beehiiv / Substack / Kit
- Hledáte **B2B CRM integration** – HubSpot
- Provozujete **multi-channel marketing** (SMS, WhatsApp) – Brevo / SALESmanago
- Cíl je **complete customer lifecycle** management – any marketing automation suite
- Hledáte **Czech UI** – Boldem / Ecomail / SmartEmailing / Mailkit
- Hlavní jazyk je **němčina** – CleverReach / Inxmail / Mapp
- Provozujete **landing pages business** – Unbounce / GetResponse / HubSpot
- Cíl je **lead scoring + nurturing** – Evalanche / ActiveCampaign
- Vyžadujete **CDP** s deep segmentation – Bloomreach / Klaviyo / SALESmanago
- Provozujete **paid newsletter** – Beehiiv / Substack
