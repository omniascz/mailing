# rapidmail – hloubková analýza funkcí
...
> - **No-frills focus** – does newsletter very well, deliberately doesn't try to be all-in-one
> - **Free phone + email support** v němčině (~9 min průměrná odpověď!)
> - **3-language UI** (English, German, French) – limited international
> - **DSGVO native compliance** (German privacy law leadership)
...
1. [Co je rapidmail a pro koho je](#1-co-je-rapidmail)
2. [Tarify a pricing model (pay-per-mail UNIKÁTNÍ)](#2-tarify)
3. [Klíčové diferenciátory v DACH kontextu](#3-diferenciatory)
4. [Recipient management](#4-recipients)
5. [Email Campaigns & Drag-and-drop editor](#5-email-campaigns)
6. [Templates (250+ + 1.5M images)](#6-templates)
7. [Sign-up forms (multiple types)](#7-forms)
8. [Basic automation (Autoresponders)](#8-automation)
9. [Personalizace a segmentace](#9-personalization)
10. [A/B Testing](#10-ab-testing)
11. [Reports & Analytics](#11-reports)
12. [Deliverability (CSA-certified, Made in Germany)](#12-deliverability)
13. [Spam test + deliverability test](#13-spam-test)
14. [Display test (multi-device preview)](#14-display-test)
15. [Telefon support (UNIKÁTNÍ pro DACH)](#15-support)
16. [Integrace](#16-integrace)
17. [Transactional emails (add-on)](#17-transactional)
18. [Compliance, GDPR/DSGVO, Made in Germany](#18-compliance)
19. [No API (ALE důležitá poznámka)](#19-no-api)
...
- **Společnost:** rapidmail GmbH
- **HQ:** **Freiburg im Breisgau, Německo** (Schwarzwald, Baden-Württemberg)
- **Vznik:** **2008** – německý origin
- **Velikost:** **80 000+** customers (per Software Suggest), **~200 000+** (per některé recenze 2026)
- **Pozice:** **DACH SMB newsletter specialist** – occasional senders + regular senders
...
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ Email          │  │ Sign-up      │  │ Basic           │      │
│  │ Newsletter     │  │ Forms        │  │ Automation      │      │
│  │ Campaigns      │  │ (Pop-up,     │  │ (Welcome,       │      │
│  │ (drag-drop)    │  │  Exit-intent)│  │  Birthday)      │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ 250+           │  │ 1.5 Million+ │  │ Recipient       │      │
│  │ Templates      │  │ Free Images  │  │ Management      │      │
│  │ (responsive)   │  │ Library      │  │ + Segmentation  │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ A/B Testing    │  │ Real-time    │  │ Personalization │      │
│  │ (Performance + │  │ Reports +    │  │ (basic)         │      │
│  │  higher plans) │  │ Statistics   │  │                 │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ Spam Test +    │  │ Display Test │  │ Phone Support   │      │
│  │ Deliverability │  │ (multi-      │  │ (FREE, ~9 min   │      │
│  │ Test           │  │  device)     │  │  response!)     │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
├─────────────────────────────────────────────────────────────────┤
│   PRICING MODELS (UNIKÁTNÍ pay-per-mail!):                      │
│   ├─ Free tier: up to 10 recipients                             │
│   ├─ Pay-per-Mail: from €16/send (250 recipients)               │
...
│   └─ Whitelisted by major DE ISPs (GMX, web.de, T-Online)       │
├─────────────────────────────────────────────────────────────────┤
│   + 3 UI languages (EN, DE, FR) - DE primary                    │
│   + DSGVO native compliance                                     │
│   + Free phone + email support v němčině                        │
│   + ~9 min průměrná response time (!!!)                         │
...
- **Occasional senders** (4-12 newsletters/year)
- **DACH SMB** newsletters
- **Local businesses** (yoga studios, restaurants, retail)
- **Non-profits + associations** (Vereinen)
- **Freelancers + Selbstständige**
- **Regulated industries** vyžadující German jurisdiction
- **DSGVO-conscious organizations**
- **Beginners** v email marketingu (simplicity focus)
...
## 2. Tarify a pricing model (pay-per-mail UNIKÁTNÍ)
...
- **From €16/mailing** for up to 250 recipients
- **From €0.001 per message** scaling
- **Credits valid 12 months**
- **First send free** up to 2 000 recipients (per Trusted)
- **1 user** v této tier
...
- Pro **regular senders** (weekly+ frequency)
...
- Separate from marketing volume

### 2.6 Free trial / Free plan

- **First send FREE** up to 2 000 recipients (per Trusted)
- **Always free** up to 10 recipients
...
- Major content advantage

### 3.7 DSGVO native compliance

- **Servers v Německu** (not EU general)
- **Double opt-in default**
- **Consent tracking built-in**
- **Auftragsverarbeitungsvertrag (DPA)** as standard
- **German privacy law** native expertise
- **DSGVO leadership** unmatched
...
**Trade-off:** Pro complex needs is rapidmail nedostačující – výslovně to říká.
...
### 4.2 Recipient lists (Empfängerlisten)
...
- **Copy-paste**
- **Field mapping**
- **GDPR consent confirmation** required (DSGVO!)
- **Blacklist management** automatic
- **Duplicate handling**
- **Export** to CSV
...
- **Block-based structure:**
  - Text blocks
  - Image blocks (1.5M+ images library)
  - Button blocks
  - Spacer / Divider
  - Social icons
  - Video embed
...
### 5.3 Campaign workflow

```
Newsletter → Neue Kampagne / New campaign
   ↓
Step 1: Setup
- Campaign name (internal)
- Subject line (Betreff)
- Sender (verified, Absender)
...
- Generates branded templates instantly
- **Performance tier+** feature

### 5.6 Personalization tokens

- `[NAME]`, `[FIRSTNAME]`, custom fields
- Default fallback values
- German case handling (basic, ne tak sofistikovaný jako SmartEmailing)

### 5.7 Send options

- **Send now** (Versand ab sofort)
- **Schedule** date + time (Versandterminierung)
- **Per Performance+** advanced scheduling

---

## 6. Templates (250+ + 1.5M images)
...
- Categories:
  ...
  - Welcome
  - Holiday/seasonal
  - **German-style designs** (DACH conventions)
  - B2B
  - Non-profit
- **Fully customizable**

### 6.2 1.5 Million+ image library

- **Massive built-in stock library**
- **Commercial use cleared**
- **No external service** needed
...
- **Less flashy** than US-focused templates
- **Familiar to German users**

---

## 7. Sign-up forms (multiple types)
...
⚠️ Better form variety than CleverReach (which has limited form types).
...
- **Unlimited:** no form limit

---

## 8. Basic automation (Autoresponders)
...
- Send email
- Wait (time delay)
- Basic condition (if/else)
- Add/remove tag

### 8.4 Pre-built scenarios
...
- **Cart abandonment** (limited)

### 8.6 Per plan automation limits
...
## 9. Personalizace a segmentace

### 9.1 Personalization tokens
...
- Basic salutation handling

### 9.3 Dynamic content (limited)

- Limited conditional content blocks
- Per Newsletter-tools.de: basic capabilities
...
### 10.1 A/B testing capabilities

- **Subject line testing**
- **Sender name testing**
- **Content variants**
- Limited variants count
...
### 11.2 Versandstatistiken (Send statistics)

- **Per-campaign reports**
- **Comparison capabilities** (limited)
- **Trends over time**
...
### 11.4 Recipient activity

- **Per-recipient timeline** (basic)
- **Engagement patterns**
...
- No advanced segmentation reports
- No predictive analytics

---

## 12. Deliverability (CSA-certified, Made in Germany)
...
### 12.7 Gmail/Yahoo 2024+ compliance
...
## 13. Spam test + deliverability test
...
- **Identify issues** before sending
- **Better engagement**

---

## 14. Display test (multi-device preview)
...
- **Email client variations:**
  ...
  - GMX
  - web.de
- **Dark mode preview** (modern email clients)

### 14.2 Why it matters

- **Ensure consistent rendering**
- **Mobile optimization** (60%+ opens on mobile)
- **Catch rendering issues** before send
- **Brand consistency**

---

## 15. Telefon support (UNIKÁTNÍ pro DACH)
...
- **Live chat** also available (per GetApp)
...
⚠️ **Lepší than CleverReach** which has NO live chat.

---

## 16. Integrace

### 16.1 Integrations (limited)
...
- Workarounds: Zapier, WordPress plugin

⚠️ Per Crunchbase / some sources different info – check current state with vendor.

### 16.3 Zapier (limited)

- Some Zapier connection available
- Triggers / Actions limited
- Not as comprehensive as CleverReach Zapier

### 16.4 Webhook support

- **Limited webhooks** (per current state)
- **Bounces, unsubscribes** typical
...
For complex integrations: **outgrow rapidmail to other platforms**.

---

## 17. Transactional emails (add-on)
...
### 17.2 Less feature-rich vs. dedicated transactional

- **Less than Postmark / Mailgun**
- **Less than Brevo transactional**
- **Sufficient for SMB** use cases

---

## 18. Compliance, GDPR/DSGVO, Made in Germany
...
- **Government**
- **Legal services**
- **DACH organizations** s strict requirements

### 18.5 Compliance certifications

- **GDPR/DSGVO** native
- **CSA certified** (Certified Senders Alliance)
- **CAN-SPAM** (US)
- **CASL** (Canadian)
...
- **Audit logs** (basic)
- **EU data residency** (exclusive Germany!)
...
## 19. No API (ALE důležitá poznámka)
...
- **Cannot programmatically:**
  - Add contacts (must use forms / CSV)
  - Trigger custom events
  - Pull reports (manual export only)
...
- **Email piping** (some setups)

### 19.4 Implications pro rapidmail's positioning

- **SMB / non-technical focus**
- **No dev-heavy organizations**
- **Pre-built integrations only**
- **Outgrow to platforms with API**

⚠️ Note: Some sources indicate basic API access in higher tiers – check current state with vendor.

---

## 20. Limity a nedostatky

### 20.1 No API (critical limitation)

- **No public API** (per GetApp)
- **No custom integrations**
- **No developer tools**
- Workarounds: Zapier (limited), CSV, plugins
...
### 20.4 Limited international

- **3 UI languages only** (EN, DE, FR)
- **No Spanish/Italian/Dutch** (vs. CleverReach 6 jazyků)
- **No CEE languages** (no CZ/SK/PL/HU)
- **Primarily DACH**
...
### 20.9 No autonomous AI

- **No AI agents** (vs. Klaviyo, HubSpot)
- **No generative AI** for content
- **1-Click-Design** je rule-based (Performance+)
- AI roadmap evolving

### 20.10 No multi-user free

- **Pay-per-mail:** 1 user only
- **Starter:** 1-2 users
- **Higher tiers needed pro team**
- **vs. CleverReach unlimited users!**

### 20.11 Personalization limitations
...
- **No native mobile app** (per current state)
- **Most operations** require desktop

### 20.14 No webinars / courses / paid newsletters
...
### 20.15 Less DTC-focused vs. Klaviyo
...
### 20.16 Less enterprise

- **Less customization** for large brands
...
- Vyžadujete **DSGVO-strict compliance** (regulated DACH industries)
- Posíláte **occasionally** (4-12 newsletters/year) – pay-per-mail je perfect
- Provozujete **non-profit / association** (Verein, occasional sender)
- Hledáte **free phone support v němčině**
- Provozujete **yoga studio / restaurant / handwerksbetrieb** (local DACH)
- Jste **beginner** v email marketingu
- Vyžadujete **German jurisdiction guaranteed**
- Hledáte **clean, no-frills** newsletter tool
- Hodnotíte **~9 min response time** support
...
- Potřebujete **API integrace** (rapidmail nemá API!)
- Provozujete **enterprise** s 100K+ kontaktů – SAP Emarsys / Salesforce
- Hledáte **autonomous AI agents** – Klaviyo / HubSpot
- Hlavní jazyk je **čeština / slovenština / polština** – Ecomail / SmartEmailing / SALESmanago
- Provozujete **webinars / courses business** – GetResponse
- Hledáte **e-commerce CDP** – ExpertSender / Bloomreach
- Potřebujete **lead scoring + CRM integration**
- Cíl je **paid newsletter business** – Beehiiv / Substack / Kit
- Provozujete **content creator business** – Kit / MailerLite
