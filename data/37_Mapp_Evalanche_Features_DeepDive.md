# Mapp & Evalanche – hloubková analýza funkcí

**Verze dokumentu:** 1.0 · **Datum:** květen 2026
**Zdroje:** oficiální dokumentace mapp.com + sc-networks.com/evalanche + analytické weby (GetApp, Capterra, G2, OMR Reviews, SoftwareAdvice, SoftwareSuggest, Research.com, FitGap, Business.digital) ověřené v dubnu–květnu 2026.
**Rozsah:** kompletní funkcionalita obou platforem v roce 2026 – **Mapp Marketing Cloud (B2C/D2C CDP)** + **Evalanche (B2B marketing automation)**.
...
> - **Současné HQ:** kombinace San Diego (US) + různé EU lokace (München, Berlin, London)
> - **Target:** **mid-market + enterprise B2C/D2C**
...
> - **Used by 1,500+ companies** (per historical data, likely higher now)
> - **Target:** **Mid-market + enterprise B2B**
> - **Best-of-Breed approach** – integrates do existing CRM landscapes
> - **ISO 27001 TÜV-certified**
> - **Servers exclusively v Germany**
>
> **Proč v jednom dokumentu:** Obě platformy obsluhují **DACH mid-market+ enterprise**, často jsou hodnoceny společně v B2B reportech, mají **podobnou cenovou kategorii**, **Made in Germany / EU compliance**, **DACH industry expertise**. Klíčový rozdíl: **Mapp = B2C/D2C CDP**, **Evalanche = B2B marketing automation**.
...
4. [Mapp CDP](#4-mapp-cdp)
5. [Mapp AI-powered analytics](#5-mapp-ai)
6. [Mapp cross-channel marketing](#6-mapp-cross-channel)
7. [Mapp integrations](#7-mapp-integrations)
...
12. [Evalanche Campaign Designer](#12-campaign-designer)
13. [Evalanche Lead Management + Scoring](#13-evalanche-leads)
14. [Evalanche PowerSets](#14-powersets)
15. [Evalanche integrace + Best-of-Breed](#15-evalanche-integrations)
16. [Evalanche compliance + ISO 27001](#16-evalanche-compliance)
...
- **Společnost:** Mapp Digital
- **Pozice:** **B2C/D2C enterprise Customer Engagement Platform**
- **Heritage:** Teradata Marketing Applications → BlueHornet → Webtrekk acquisitions consolidated
- **Současné offices:** San Diego (US headquarters), London, Munich, Berlin, multiple EU
- **Specializace:** **B2C/D2C mid-market + enterprise**
- **UI Languages:** **English, French, German, Italian, Spanish** (5 languages)
- **Industries:** Retail, eCommerce, finance, travel, fashion
- **Web:** mapp.com
...
- **Personalize content** using customer insights
- **Automate cross-channel marketing** (website, emails, SMS, mobile/web push, in-app messages)

### Reference customers (per oficiální)

- **Obayaty** (men's self-care, personalization)
- **PizzaExpress** (omnichannel, loyalty app)
- **Three Business** (telecom, key phone launches)

```
┌─────────────────────────────────────────────────────────────────┐
│              MAPP MARKETING CLOUD (B2C/D2C focus)               │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ CDP            │  │ AI-Powered   │  │ Cross-Channel   │      │
│  │ (Customer Data │  │ Digital      │  │ Marketing       │      │
...
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ In-App         │  │ Website      │  │ Personalization │      │
│  │ Messages       │  │ Banners +    │  │ Engine          │      │
│  │                │  │ Overlays     │  │                 │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ Predictive AI  │  │ Audience     │  │ Customer        │      │
│  │ (churn, CLV,   │  │ Segmentation │  │ Journey         │      │
│  │ next-best)     │  │              │  │ Orchestration   │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
├─────────────────────────────────────────────────────────────────┤
│   CORE STRENGTHS:                                               │
│   ├─ Unified CDP + Marketing Automation                         │
│   ├─ AI-powered analytics                                       │
│   ├─ European heritage + GDPR compliance                        │
│   ├─ Data residency options                                     │
│   ├─ B2C/D2C focus                                              │
│   └─ Mid-market + enterprise                                    │
├─────────────────────────────────────────────────────────────────┤
│   PRICING:                                                      │
│   - Custom enterprise pricing (no public)                       │
...
- **No free trial** standardní

### 2.2 Pricing factors

- **Number of profiles** v CDP
...
### 2.3 Typical enterprise spend

- **Mid-market:** ~€2,000-10,000/month
- **Enterprise:** €10,000+/month
- **Large enterprise:** €30,000+/month
- (Estimates based on industry comparables)

### 2.4 What's typically included

- **Mapp Marketing Cloud platform**
- **CDP capabilities**
- **AI analytics**
...
### 3.5 Cross-channel orchestration
...
- **Websites** (s tracking)
- **eCommerce platforms** (Shopify, Magento, Shopware)
- **Loyalty platforms**
- **CRMs**
- **Mobile apps**
- **APIs** (custom)
...
### 4.4 Data unification

- **Cross-device tracking**
- **Cross-channel attribution**
- **Identity resolution** (email, cookie, customer ID)
- **Master profile** maintained

---

## 5. Mapp AI-powered analytics
...
- "Who needs a nudge to stay engaged?"
- "Where are your campaigns hitting the mark?"
- ROI optimization
- Investment allocation

### 5.4 vs. competitors

- **Klaviyo Customer Agent** – more autonomous
- **HubSpot Breeze** – broader AI suite
- **Mapp AI** – analytics-focused, predictive

---

## 6. Mapp cross-channel marketing
...
### 8.2 Fewer integrations than market leaders

- **Vs. HubSpot** smaller marketplace
- **Vs. Salesforce Marketing Cloud** fewer connectors
- **Custom API development** often needed
...
- **5 languages** (EN, FR, DE, IT, ES)
- **No CZ / SK / PL** UI (vs. Inxmail)
- **No Asian languages**

### 8.11 B2C/D2C focus = limited B2B

- **B2B features** less developed
- **No lead scoring** v traditional B2B sense
- **B2B may prefer Evalanche** instead
...
- **Best-of-Breed approach** (ne all-in-one)
- **TÜV SÜD certified** (world's first email marketing solution certified for functionality + data security)
- **TOP100 winner** 2012 (innovative German Mittelstand)
- **ISO 27001 TÜV-certified** (annual re-certifications)
- **Used by 25+ year history** clients
- **Designed pro agencies + larger enterprises** marketing departments
...
- **Payone**
- **Jauch Quartz** (elektrotechnika)
- **B2B Maschinenbauer** s SAP CRM
...
│              ISO 27001 TÜV · 25+ Jahre Erfahrung                │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ Email          │  │ Campaign     │  │ Lead            │      │
│  │ Marketing      │  │ Designer     │  │ Management      │      │
│  │ (hyper-        │  │ (visual)     │  │ (Scoring +      │      │
│  │ personalized)  │  │              │  │  Profiling)     │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ Landing Pages  │  │ Forms        │  │ PowerSets       │      │
│  │ (lead gen)     │  │ (Progressive │  │ (pre-          │      │
│  │                │  │  Profiling)  │  │ configured     │      │
│  │                │  │              │  │ modules)       │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ KI-gestützte   │  │ Marketing    │  │ Buyer Personas  │      │
│  │ Content        │  │ Cockpit      │  │ Tokens          │      │
│  │ Frameworks     │  │ (Performance │  │                 │      │
│  │ (AI assist)    │  │  Real-time)  │  │                 │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ Multi-Tenant   │  │ A/B/Split    │  │ Multivariate    │      │
│  │ (multi-brand/  │  │ Tests        │  │ Scoring         │      │
│  │ multi-unit)    │  │              │  │                 │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
│  ┌────────────────┐  ┌──────────────┐  ┌─────────────────┐      │
│  │ Print          │  │ SAP CRM      │  │ DACH CRM        │      │
│  │ Integration    │  │ Integration  │  │ Integrations    │      │
│  │ (Fax, Brief)   │  │ Native       │  │ (itmX, ...)     │      │
│  └────────────────┘  └──────────────┘  └─────────────────┘      │
│                                                                 │
├─────────────────────────────────────────────────────────────────┤
│   "MADE IN GERMANY":                                            │
...
│   ├─ TÜV SÜD certified (1st email tool world!)                  │
│   ├─ TOP100 innovativeste Mittelständler                        │
│   └─ 25+ years industry experience                              │
├─────────────────────────────────────────────────────────────────┤
│   PRICING:                                                      │
│   - Nutzungsbasierte Tarife (usage-based)                       │
│   - PowerSets (pre-configured solutions)                        │
│   - Prices on request (Anfrage)                                 │
│   - Mid-market + enterprise focus                               │
├─────────────────────────────────────────────────────────────────┤
│   APPROACH: "Best-of-Breed"                                     │
│   ├─ Integrates s existing CRM landscape                        │
│   ├─ Doesn't replace systems                                    │
│   ├─ Specialized marketing tool                                 │
│   └─ Open API + adapter hub                                     │
└─────────────────────────────────────────────────────────────────┘
```

---

## 10. Evalanche tarify (nutzungsbasiert)
...
- **PowerSets** pre-configured solutions
- **Prices on request** (sales-driven)

### 10.2 Pricing factors

- **Number of profiles** v database
- **Email volume**
...
- **Powered by Design System**

### 10.4 Why usage-based matters

- **Scales s growth**
- **No overpaying** during low-usage periods
- **Aligns cost s value**
- **Predictable** within usage tiers

---

## 11. Evalanche diferenciátory
...
## 12. Evalanche Campaign Designer
...
- Multi-step B2B journeys
- Whitepaper → case study → webinar invitations
- Cross-channel (email + landing pages + print)
```
...
## 13. Evalanche Lead Management + Scoring
...
- **Lead Nurturing**
- **Lead Profiling** (Progressive)
- **Sales Handoff**

### 13.2 Lead Generation

- **Landing Pages** dedicated
...
- **Less friction** vs. long initial forms
...
### 13.5 Buyer Persona integration

- **Defined personas** v platform
- **Auto-match** profiles to personas
...
```
Lead reaches scoring threshold
   ↓
Auto-qualification
   ↓
Push to CRM (SAP, Salesforce, itmX, etc.)
   ↓
...
## 15. Evalanche integrace + Best-of-Breed
...
- **Payone** → system landscape simplification

---

## 16. Evalanche compliance + ISO 27001
...
- **TÜV Hessen** auditor
- **Annual re-certifications**
- **SC-Networks + data centers** both certified
...
### 17.6 B2B focus = limited B2C

- **B2B specialty**
- **B2C features less developed**
- **B2C may prefer Mapp** instead
- **DTC e-commerce** better served by Klaviyo / Mapp

### 17.7 Lower brand awareness

- **DACH known**, less international
- **Vs. HubSpot / Salesforce Marketing Cloud** smaller globally
...
## 18. Mapp vs. Evalanche head-to-head
...
Choose Mapp when:
- B2C / D2C business
- Need unified CDP + automation
- Cross-channel critical (email + SMS + push)
- Mobile app integration important
- Need predictive AI (churn, CLV)
- Mid-market+ retail / fashion / travel / finance
- High-volume consumer marketing
- Already in mid-market+ price range
```

### 18.3 When to choose Evalanche

```
Choose Evalanche when:
- B2B business (Maschinenbau, IT, Pharma, etc.)
- Need lead management + scoring focus
- Existing CRM (especially SAP CRM, itmX)
- Best-of-Breed approach preferred
- ISO 27001 strict requirement
- German servers required (not just EU)
- Multi-tenant pro subsidiaries / brands
- Print + analog channels combine s digital
- 25+ years experience valued
- Mid-market+ B2B
```
...
- Vyžadujete **AI-powered analytics** (churn, CLV, next-best-action)
- Provozujete **mobile app** s in-app + push needs
- Vyžadujete **European GDPR compliance**
- Vyžadujete **high-volume cross-channel** (email + SMS + push + in-app + web)
- Hledáte **predictive segmentation**
- Hodnotíte **EU heritage** vs. US competitors
- Budget je **mid-market+ enterprise** (€2K-30K+/month)
...
- Provozujete **pure DTC Shopify** s deep needs – Klaviyo lepší (deeper)
- Hledáte **deep B2B CRM** – HubSpot / Salesforce
- Hledáte **autonomous AI agents** – Klaviyo / HubSpot
- Vyžadujete **public pricing** transparency
- Provozujete **maschinenbau / industrial B2B** – Evalanche
...
- Vyžadujete **ISO 27001 TÜV-certified** infrastructure
- Vyžadujete **German servers** exclusively
- Provozujete **SAP CRM** business
- Provozujete **itmX CRM / CAS / combit / CURSOR** ecosystem
- Hledáte **Best-of-Breed approach** (integrate, not replace)
- Vyžadujete **multivariate scoring** + Buyer Personas
- Provozujete **multi-tenant** (subsidiaries, brands, agencies)
- Vyžadujete **Progressive Profiling** lead generation
- Provozujete business s **print + analog channels** combine s digital
- Hodnotíte **25+ years industry experience**
...
- Cíl je **simple newsletter** pro non-technical – Mailchimp / MailerLite
- Hledáte **modern UI** – Evalanche feels outdated
- Vyžadujete **public pricing** transparency
- Provozujete **DACH SMB** s budget €100/month – CleverReach / rapidmail
- Cíl je **omnichannel s SMS + WhatsApp + push** – Brevo / SALESmanago / SARE
